import { Controller, Get, Post, Body, Patch, Param, Query, UseGuards, ParseUUIDPipe, HttpCode, HttpStatus } from '@nestjs/common';
...
export class BookingsController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get all bookings with filters & search (Admin only)' })
  @ApiResponse({ status: 200, description: 'List of bookings returned with pagination.' })

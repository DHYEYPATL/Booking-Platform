import { Controller, Get, Post, Body, Patch, Param, Delete, UseGuards, Query, HttpCode, HttpStatus, ParseUUIDPipe, Req } from '@nestjs/common';
...
export class ServicesController {
  ...
  @ApiResponse({ status: 200, description: 'List of services returned with pagination.' })
  ...
  @ApiResponse({ status: 200, description: 'Service successfully updated.', type: Service })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 404, description: 'Service not found.' })
  async update(
  ...
  @ApiResponse({ status: 204, description: 'Service successfully soft-deleted.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 404, description: 'Service not found.' })
